...
class ClipController extends Controller
{
     ...
     */
    public function indexAction(Request $request, SettingService $settingService)
    {
        ...
        $result = $paginator->paginate(
            ...
            $request->query->getInt('limit', $settingService->fetchSetting('clips_per_page'))
        );

        return $this->render('frontend/clip/index.html.twig', [
            'clips' => $result
        ]);
    }
    ...
    public function newAction(Request $request, TwitchService $twitchService) {
        ...
        return $this->render('frontend/clip/new.html.twig', [
    ...
    public function editAction(Clip $clip) {
        ...
        return $this->render('frontend/clip/edit.html.twig', [
            'clip' => $clip
        ]);
    }
    ...
    public function myAction(Request $request, SettingService $settingService) {
        ...
        return $this->render("frontend/clip/my.html.twig", [
            "clips" => $result
        ]);
    }
    ...
    public function viewAction(Clip $clip) {
        return $this->render('frontend/clip/view.html.twig', [
            'clip' => $clip
        ]);
    }
}
